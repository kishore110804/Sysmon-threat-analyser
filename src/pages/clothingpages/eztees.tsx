...
export default function EzTees() {
  return (
    <>
      <Navbar />
      <VerticalNav />
      <section className="container mx-auto py-16 px-4 mt-10">
        <div className="flex flex-col items-start gap-2 mb-8">
          <h1 className="text-5xl md:text-7xl font-heading font-bold">EZ-TEES</h1>
          <p className="text-lg text-muted-foreground max-w-2xl">
            Comfortable t-shirts crafted with premium materials and contemporary designs.
          </p>
        </div>
